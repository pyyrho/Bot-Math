...
def _recipient_layout(
    ...
    *,
    ...
    description = (
        ...
        f"## {subject}\n"
        f"{_quote(message)}\n\n"
        "A identidade do responsável não é exibida para preservar o atendimento da equipe."
    )
    return build_layout(
        ...
        thumbnail=thumbnail,
        footer=(
            f"Código do aviso: {notice_id} · Para falar com a equipe, "
            "utilize o sistema de tickets do servidor."
        ),
        timeout=None,
    )
